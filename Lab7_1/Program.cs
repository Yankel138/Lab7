...
namespace Lab7_1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if ((x1 + y1 <= z1) || (x1 + z1 <= y1) || (z1 + y1 <= x1) || (x2 + y2 <= z2) || (x2 + z2 <= y2) || (z2 + y2 <= x2))
            {
                Console.WriteLine("Ошибка. Один или оба ваших треугольника вовсе не треугольники!");
            }
            ...
            {
                Console.WriteLine("Площадь первого треугольника равна площади второго треугольника ({0:f2})", s1);
            }
            Console.ReadKey();
        }
